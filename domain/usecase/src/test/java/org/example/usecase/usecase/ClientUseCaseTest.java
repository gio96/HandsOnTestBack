...
public class ClientUseCaseTest {
    ...
    @Test
    public void getTotalSalaryHourlyEmployees() {
        //arrange
        Employee employee = new HourlyEmployeeTestDataBuilder().build();
    ...
    @Test
    public void getTotalSalaryMonthlyEmployees() {
        //arrange
    ...
    public void getEmployeeNull() {
        ...
        //assert
        Assert.assertNull(clientUseCase.getEmployee(3));
